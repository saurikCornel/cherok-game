...
struct ShopView: View {
    ...
    private let cardOptions: [CardOption] = [
        CardOption(id: "firstCard", buyImage: "firstCardBuy", selectImage: "firstCardSelect", closeImage: "card1", selectedImage: "firstCardSelected"),
        CardOption(id: "spaceCard", buyImage: "spaceCardBuy", selectImage: "spaceCardSelect", closeImage: "card2", selectedImage: "spaceCardSelected"),
        CardOption(id: "futureCard", buyImage: "futureCardBuy", selectImage: "futureCardSelect", closeImage: "card3", selectedImage: "futureCardSelected")
    ]
...
//                            BalanceTemplate()
//                        }
//                        .position(x: geometry.size.width / 1.2, y: geometry.size.height / 16)
//                    } else {
//                        BalanceTemplate()
